...
Install ffmpeg and make sure ffmpeg.exe and ffprobe.exe are on your PATH.
...
Edit .env with platform credentials after you have official API access.
...
Get written permission or confirm the license allows reposting on TikTok, Instagram, and YouTube.
Add a sources entry in config.yaml.
Add or confirm license, permission_note, creator, credit_url, and tags.
Run collect in dry-run mode and inspect data/reposter.sqlite or the dashboard.
Render and review videos locally before enabling real posting.
API Credentials
